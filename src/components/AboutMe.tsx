    ...
    <div className="flex flex-col md:flex-row gap-2 md:gap-3 mb-2 md:mb-3">
      <div className="flex-shrink-0">
        <img
          ...
          alt="Profile"
          className="w-16 md:w-28 h-16 md:h-28 object-cover rounded-xl shadow-lg"
        />
      </div>
      <div className="flex-grow flex flex-col">
        ...
        <div className="mt-1.5 space-y-1">
          ...
          <div className="flex flex-wrap gap-1">
            <Button variant="outline" size="sm" className="h-5 px-1.5 text-[8px] md:text-[9px] text-blue-400 hover:text-blue-300">
            ...
            <Button variant="outline" size="sm" className="h-5 px-1.5 text-[8px] md:text-[9px] text-blue-400 hover:text-blue-300 font-secondary">
          ...
          <div className="flex flex-wrap gap-1">
            <Button variant="outline" size="sm" className="h-5 px-1.5 text-[8px] md:text-[9px] text-blue-400 hover:text-blue-300 font-sans">
